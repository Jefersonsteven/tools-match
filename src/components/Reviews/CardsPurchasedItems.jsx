  ...
  return (
    ...
    >
      <div className="w-full max-w-xl mb-4">
        <div className="text-gray-600 text-lg">{orderDate}</div> {/* Ajusta el tamaño de la fecha */}
        <div className="text-black font-bold text-3xl mb-4 mt-2"> {/* Ajusta el margen superior e inferior del mensaje */}
